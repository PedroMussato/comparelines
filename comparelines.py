...
case_sensitive = get_no_case_sensitive_param(sys.argv)
...
if left_file_path and right_file_path and join_type and join_type:
    ...
    if join_type == 'left':
        result_lines = left_join(left_file_lines,right_file_lines,unique,case_sensitive)
    elif join_type == 'right':
        result_lines = right_join(left_file_lines,right_file_lines,unique,case_sensitive)
    elif join_type == 'inner':
        result_lines = inner_join(left_file_lines,right_file_lines,unique,case_sensitive)
    elif join_type == 'outer':
        result_lines = outer_join(left_file_lines,right_file_lines,unique,case_sensitive)
    elif join_type == 'full-outer':
        result_lines = full_outer_join(left_file_lines,right_file_lines,unique,case_sensitive)
